...
class CudaLayer:
    ...
    def initialize(self, arr, low=-1, high=1, mode=None):
        ...
        self.history['w_init'] = np.linalg.norm(self.weights)
    ...
    def backward(self, error, lr):
        self.history['w'].append(np.linalg.norm(self.weights))
    ...
    def state(self):
        return [self.logs['act'], self.weights]
...
class CudaNetwork:
    ...
    def __init__(self, poly_reg=False):
